...
<head>
    ...
    <title>Institutions-Login Page</title>
    <!-- CSS -->
    ...
    echo $msg;
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <p class="forget-pass text-white"><a href="forgot-password.php">Forgot Password ?</a>  <a href="comp-signup.php" style="padding-left: 250px">New Institution Sign Up!!</a></p>
