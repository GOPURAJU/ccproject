                        ...
                        <div class="logo">
                            <h1>
                                <a class="navbar-brand" href="index.php">
                                    <i class="fab fa-codepen"></i> CAREER CONNECT</a>
                            </h1>
                        </div>
...
<?php
 ...
 if($_SESSION['crmsuid']==0){?>
                                 ...
                                 <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="./government/login.php" id="navbarDropdown1">
                                       Government
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="./user/login.php" id="navbarDropdown">
                                        Candidates
                                        <!-- <i class="fas fa-angle-down"></i> -->
                                    </a>
                                    <!-- <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="institutions/login.php" id="navbarDropdown1">
                                      Institutions
                                        <!-- <i class="fas fa-angle-down"></i> -->
                                    </a>
                                    <!-- <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="./company/login.php" id="navbarDropdown1">
                                        Companies
                                        <!-- <i class="fas fa-angle-down"></i> -->
                                    </a>
                                    <!-- <div class="dropdown-menu" aria-labelledby="navbarDropdown">
