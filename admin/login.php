...
<head>
    ...
    <title>Admin Career Connect-Login Page</title>
    <!-- CSS -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6 p-t-100">
                    <div class="text-white">
                        <h1>Admin Login</h1>
                        <p class="s-18 p-t-b-20 font-weight-lighter"> Welcome to Career Connect Admin Panel !</p>
                    </div>
    ...
    echo $msg;
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <p class="forget-pass text-white"><a href="forgot-password.php"> Forgot Password ?</a></p>
