...
<head>
    ...
    <title>Candidates-Login Page</title>
    <!-- CSS -->
    ...
    echo $msg;
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <p class="forget-pass text-white"><a href="forgot-password.php"> Forgot password ?</a><a href="user-signup.php" style="padding-left: 250px">New Candidate Sign Up!!</a></p>
